"""TF1.1: Automated integration test for PostgreSQL checkpoint and service restart persistence.

Verifies that LangGraph checkpoint state created by AsyncPostgresSaver survives
full service disposal and recreation across multi-turn human review cycles.
"""
